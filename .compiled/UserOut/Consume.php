...
class Consume extends Foundation\ActorOut\Read {
    ...
    const SETTABLES_EXTRA = [\PhoNetworksAutogenerated\User::class,\PhoNetworksAutogenerated\StatusUpdate::class,\PhoNetworksAutogenerated\Group::class,\PhoNetworksAutogenerated\Event::class,\PhoNetworksAutogenerated\BlogPost::class,\PhoNetworksAutogenerated\Photo::class,\PhoNetworksAutogenerated\Video::class,\PhoNetworksAutogenerated\Page::class];
 ...
 * Timestamp: 
 * Size (in bytes): 1556
 * Compilation Time: 3635
 * 61946e8815595d5ce33d50f56b16b436
 ******************************************************/